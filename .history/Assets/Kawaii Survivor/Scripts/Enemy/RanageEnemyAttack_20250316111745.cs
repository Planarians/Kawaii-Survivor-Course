...
public class RanageEnemyAttack : MonoBehaviour
{
    ...
    {
        EnemyBullet bulletInstance = Instantiate(bulletPrefab, shootPoint.position, Quaternion.identity).GetComponent<EnemyBullet>();
    ...
    {
        enemyBullet.Reload();
        enemyBullet.transform.position = shootPoint.position;
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawLine(shootPoint.position, (Vector2)shootPoint.position + gizmosDirection * 10f);
    }
}
